...
set_clock_groups -name clk_tproc_to_dac2 -asynchronous -group [get_clocks [get_clocks -of_objects [get_nets -of_objects [get_pins d_1_i/usp_rf_data_converter_0/clk_dac0]]]] -group [get_clocks [get_clocks -of_objects [get_nets -of_objects [get_pins d_1_i/usp_rf_data_converter_0/clk_dac2]]]]

set_clock_groups -name clk_tproc_to_adc0_x2 -asynchronous -group [get_clocks [get_clocks -of_objects [get_nets -of_objects [get_pins d_1_i/usp_rf_data_converter_0/clk_dac0]]]] -group [get_clocks [get_clocks -of_objects [get_nets -of_objects [get_pins d_1_i/clk_adc0_x2/clk_out1]]]]

# axi to DDR4, DDR4 to RO fabric
set_clock_groups -name clk_axi_to_ddr4 -asynchronous -group [get_clocks [get_clocks -of_objects [get_nets -of_objects [get_pins d_1_i/zynq_ultra_ps_e_0/pl_clk0]]]] -group [get_clocks [get_clocks -of_objects [get_nets -of_objects [get_pins d_1_i/ddr4_0/c0_ddr4_ui_clk]]]]

set_clock_groups -name clk_ddr4_to_adc0_x2 -asynchronous -group [get_clocks [get_clocks -of_objects [get_nets -of_objects [get_pins d_1_i/ddr4_0/c0_ddr4_ui_clk]]]] -group [get_clocks [get_clocks -of_objects [get_nets -of_objects [get_pins d_1_i/clk_adc0_x2/clk_out1]]]]
