...
* `qickdawg_4x2_2xDAC`     - DAC sampling rate = 9.8 GSPS. DAC fabric clk = 614.40 MHz, ADC fabric clk = 307.2 MHz, tprocessor = 307.2 MHz. DAC is 2x faster than the ADC and tproc.

#### ZCU216
* `qickdawg_216_commonClk` - All clocks including the DAC, ADC and tprocessor are synced at 307.2 MHz.
* `qickdawg_216_2xDAC`     - DAC sampling rate = 9.8 GSPS. DAC fabric clk = 614.40 MHz, ADC fabric clk = 307.2 MHz, tprocessor = 307.2 MHz. DAC is 2x faster than the ADC and tproc.
