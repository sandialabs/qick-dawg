...
![Rabi Pulse Sequence Example](RABI_example1.png)
![Rabi Pulse Sequence Example](RABI_example2.png "Figure 1. Example use of QICK-DAWG to perform Rabi oscillations from the demo Jupyter notebook.
")
