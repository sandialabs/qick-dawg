...
CPMG
=======================================================================
An NVAveragerProgram class acquires data for CPMG, 
i.e. a mw pluse sequence of:
pi/2 (x) - 1t delay - pi (y) - 2t delay - pi (y) - 2t delay - pi (y) - 1t delay - pi/2 (x). 
'''
...
class CPMG(NVAveragerProgram):
    ...
    Returns
    `.CPMG`
        An instance of CMPG with compiled assembly language
    ...
    def body(self):
        ...
        For CPMG this peforms FILL THIS IN 
        '''
